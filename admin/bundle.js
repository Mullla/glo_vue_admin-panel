...
var DOMHelper = require("./domHelper"); // эта библиотека нужна для того, чтобы обойти кэширование у браузера
...
module.exports = /*#__PURE__*/function () {
  ...
  _createClass(Editor, [{
    ...
    value: function onTextEdit(element) {
      ...
      this.virtualDom.body.querySelector("[node_id=\"".concat(id, "\"]")).innerHTML = element.innerHTML;
    }
  }, {
    key: "save",
    value: function save() {
...
},{"./domHelper":1,"./iframe-load":3,"axios":5}],3:[function(require,module,exports){
"use strict";
...
var Editor = require('./editor'); // для объекта window создаем свойство editor, куда записываем наш созданный класс Editor
